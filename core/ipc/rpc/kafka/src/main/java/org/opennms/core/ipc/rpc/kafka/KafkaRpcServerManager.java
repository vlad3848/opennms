...
public class KafkaRpcServerManager {
    ...
    public void init() throws IOException {
        ...
        final JmsQueueNameFactory topicNameFactory = new JmsQueueNameFactory(KafkaRpcConstants.RPC_REQUEST_TOPIC_NAME, null,
        ...
        KafkaConsumerRunner kafkaConsumerRunner = new KafkaConsumerRunner(consumer, topicNameFactory.getName());
    ...
    class KafkaConsumerRunner implements Runnable {
                ...
                while (!closed.get()) {
                    ...
                    for (ConsumerRecord<String, byte[]> record : records) {
                        try {
                            ...
                            final RpcModule module = registerdModules.get(rpcMessage.getModuleId());
                            if(module == null) {
                                continue;
                            }
        ...
        private void sendResponse(String rpcId, RpcResponse response, RpcModule module) {
            try {
                final JmsQueueNameFactory topicNameFactory = new JmsQueueNameFactory(KafkaRpcConstants.RPC_RESPONSE_TOPIC_NAME, null);
